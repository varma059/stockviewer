package com.projects.stockviewer.stockservice.controller;
...
//        }};
//    new HttpEntity<String>(createHeaders("ashish", "kingkong"))  //this statement to pass in the exchange method.
//    }
    @GetMapping("/{userName}")
    public List<Quote> getQuotes(@PathVariable("userName") String userName) {
